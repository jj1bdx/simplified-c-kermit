...
int doxconn(int cx) {
  ...
  // that connection closed, the user says "connect" and expects a new
  // connection to be made to the same host, because that's how all the other
  // connection methods work, so (and this is quite a hack)...
