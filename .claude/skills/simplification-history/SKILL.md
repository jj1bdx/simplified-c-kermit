...
`BASE_20260616.md` is the consolidated overview of the whole campaign
...
- **Windows/OS2/VMS** removed 2026-06-12, *before* the initial commit (`SIMPLIFY_20260612.md`):
  all `ckv*` files deleted, `#ifdef` blocks stripped with unifdef.
- **Android** removed the same day, commit `ad4139f` (`SIMPLIFY_20260612_2.md`).
- **SSL/TLS + Kerberos** removed 2026-06-13 (`SIMPLIFY_20260613.md`): the whole Telnet
...
- **Non-ANSI / K&R C** removed, commit `20bf398` (`SIMPLIFY_20260613_2.md`): `CK_ANSIC` is
...
- **26 obsolete platform macros** removed from the C source, commit `c1c710b`
  (`SIMPLIFY_20260613_3.md`, `OS_FLAGS_20260613.md`): `AS400 __386BSD__ C70 CIE SINIX SNI544
...
- **Dead makefile targets** removed in waves (`SIMPLIFY_20260613_4.md`, `_5.md`, `_6.md`,
  `OS_SIMPLIFY_20260613.md`, `OS_SIMPLIFY_PLAN_20260613*.md`): first the 38 targets defining
...
- **`#ifdef COMMENT` dead-code blocks** removed, commit `3201982` merged via `f5456b8`
  (`SIMPLIFY_SUMMARY_20260613.md`): `COMMENT` was never `#define`d anywhere, so
...
- **Signal modernization** — `SIGTYP`/`SIGRETURN` expansion, the `ck_signal()` sigaction
  ...
  (`SIGTYPE_PLAN_20260615.md`, `SIGACTION_PLAN_20260615.md`, `SIGACTION_MACOS_20260615.md`,
  `CK_SIG_T_20260616.md`, `SIGNAL_TYPE_20260615.md`).
- **`ckuver.h` herald selector flattened** and **clang-format
  `SortIncludes`/`InsertBraces` enabled with `ckcdeb.h` pinned first**: see the
  **format-and-editor-tooling** skill (`SIMPLIFY_SUMMARY_20260613.md` §3,
  `MOVE_CKCDEB_H_20260615.md`, `ENABLE_SORTINCLUDES_20260615.md`, `INSERT_BRACES_20260615.md`).
- **Dead/unused file deletions**: `ckcsym.h` (`CKCSYM_H_DELETION_20260615.md`), `ckusig.h`
  ...
  makecmd.sh`). See `BASE_20260616.md` §3.
...
- Every simplification gets a dated `*_20260NNN.md` report in the repo root and a verification
