...
#define W_XFER                                                                 \
  (W_INIT | W_SEND | W_RECV | W_REMO | W_FTP) // File xfer any protocol
...
#define MAXPACK                                                                \
  94             // Maximum unextended packet size
...
#define zminchar()                                                             \
  (sndarray ? agnbyte()                                                        \
            : (((--zincnt) >= 0) ? ((int)(*zinptr++) & 0377) : zinfill()))
#endif // NOXFER
#endif // NOSPL
